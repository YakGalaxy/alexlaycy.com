...
Gem::Specification.new do |spec|
  spec.name     = "laycy"
  spec.version  = "1.0"
  spec.authors  = ["Alex Laycy"]
  spec.email    = ["alex@alexlaycy.com"]

  spec.summary  = "A minimalist Jekyll theme for a personal site."
  spec.homepage = "https://github.com/YakGalaxy/alexlaycy.com"
  spec.license  = "MIT"
